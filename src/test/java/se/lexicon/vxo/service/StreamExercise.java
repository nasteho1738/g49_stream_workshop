...
public class StreamExercise {
    ...
    public void task3() {
        ...
        //TODO:Write code here
        amount = people.stream().filter(person -> "Andersson".equals(person.getLastName())).count();
    ...
    public void task6() {
        ...
        //TODO:Write code here
        result = people.stream().filter(person -> "Erik".equals(person.getFirstName())).toArray(Person[]::new);
    ...
    public void task7() {
        ...
        //TODO:Write code here
        optional = people.stream().filter(person -> 5436 == person.getPersonId()).findFirst();
    ...
    public void task10() {
        ...
        optional = people.stream()
                .filter(person -> 5914 == person.getPersonId())
                .map(person -> person.getDateOfBirth().getDayOfWeek().name() + " " + person.getDateOfBirth().getDayOfMonth() + " " + person.getDateOfBirth().getMonth()+ " " + person.getDateOfBirth().getYear())
                .findFirst();
        assertNotNull(optional);
        assertTrue(optional.isPresent());
        assertEquals(expected, optional.get());
